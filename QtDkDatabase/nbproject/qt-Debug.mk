#############################################################################
# Makefile for building: libQtDkDatabase.so.2.0.1
...
INCPATH       = -Inbproject -I. -isystem /usr/local/include/QtSql -isystem /usr/local/include/QtCore -I. -I/usr/local/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = QtDkDatabase2.0.1
DISTDIR = /home/brasilio/NetBeansProjects/QtDkDatabase/build/Debug/GNU-Linux/QtDkDatabase2.0.1
LINK          = g++
LFLAGS        = -Wl,-rpath,/usr/local/lib -shared -Wl,-soname,libQtDkDatabase.so.2
LIBS          = $(SUBLIBS) -L/usr/local/lib -lQt5Sql -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = DkDatabase.cpp 
OBJECTS       = build/Debug/GNU-Linux/DkDatabase.o
DIST          = /usr/local/mkspecs/features/spec_pre.prf \
		...
		nbproject/nbproject/qt-Debug.pro DkDatabase.h DkDatabase.cpp
QMAKE_TARGET  = QtDkDatabase
DESTDIR       = dist/Debug/GNU-Linux/
TARGET        = libQtDkDatabase.so.2.0.1
TARGETA       = dist/Debug/GNU-Linux/libQtDkDatabase.a
TARGET0       = libQtDkDatabase.so
TARGETD       = libQtDkDatabase.so.2.0.1
TARGET1       = libQtDkDatabase.so.2
TARGET2       = libQtDkDatabase.so.2.0
...
distdir: FORCE
	...
	$(COPY_FILE) --parents DkDatabase.h $(DISTDIR)/
	$(COPY_FILE) --parents DkDatabase.cpp $(DISTDIR)/
...
build/Debug/GNU-Linux/DkDatabase.o: DkDatabase.cpp DkDatabase.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux/DkDatabase.o DkDatabase.cpp
