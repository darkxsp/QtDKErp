#############################################################################
# Makefile for building: libQtDkBusiness.so.1.0.0
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = QtDkBusiness1.0.0
DISTDIR = /home/brasilio/NetBeansProjects/QtDkBusiness/build/Debug/GNU-Linux/QtDkBusiness1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/usr/local/lib -shared -Wl,-soname,libQtDkBusiness.so.1
...
SOURCES       = DkBusiness.cpp 
OBJECTS       = build/Debug/GNU-Linux/DkBusiness.o
DIST          = /usr/local/mkspecs/features/spec_pre.prf \
		...
		nbproject/nbproject/qt-Debug.pro DkBusiness.h DkBusiness.cpp
QMAKE_TARGET  = QtDkBusiness
DESTDIR       = dist/Debug/GNU-Linux/
TARGET        = libQtDkBusiness.so.1.0.0
TARGETA       = dist/Debug/GNU-Linux/libQtDkBusiness.a
TARGET0       = libQtDkBusiness.so
TARGETD       = libQtDkBusiness.so.1.0.0
TARGET1       = libQtDkBusiness.so.1
TARGET2       = libQtDkBusiness.so.1.0
...
distdir: FORCE
	...
	$(COPY_FILE) --parents DkBusiness.h $(DISTDIR)/
	$(COPY_FILE) --parents DkBusiness.cpp $(DISTDIR)/
...
build/Debug/GNU-Linux/DkBusiness.o: DkBusiness.cpp DkBusiness.h \
		../QtDkDatabase/DkDatabase.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux/DkBusiness.o DkBusiness.cpp
